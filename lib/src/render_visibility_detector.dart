...
class RenderVisibilityDetector extends RenderProxyBox {
  ...
  VisibilityDetectorLayer lastLayer;
  void adoptLayer(VisibilityDetectorLayer layer){
    if(lastLayer == null && layer != null){
      routeNotifier.addListener(listenerRoute);
    }
  }

  void listenerRoute(){
    debugPrint("page ${routeNotifier.value}");
  }
}
